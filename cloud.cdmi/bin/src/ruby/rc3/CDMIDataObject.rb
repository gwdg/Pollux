...
class CDMIDataObject
	...
	# FIXME:  Updates the metadata of this dataobject and publish it in CDMI server
	...
	# FIXME: Removes this container from CDMI server
	...
	# FIXME: Creates a new data object
